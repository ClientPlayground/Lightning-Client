...
public class ResourcePackRepository
{
    ...
    public ListenableFuture<Object> downloadResourcePack(final String url, final String hash) {
        ...
        try {
            ...
            Futures.addCallback((ListenableFuture)(this.field_177322_i = HttpUtil.downloadResourcePack(file1, url, map, 52428800, guiscreenworking, minecraft.getProxy())), (FutureCallback)new FutureCallback<Object>() {
