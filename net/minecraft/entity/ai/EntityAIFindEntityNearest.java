...
public class EntityAIFindEntityNearest extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityLivingBase> list = this.field_179442_b.worldObj.getEntitiesWithinAABB(this.field_179439_f, this.field_179442_b.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super EntityLivingBase>)this.field_179443_c);
