...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    @Override
    public void initGui() {
        Client.getInstance().getDiscordRP().update("", "Mainmenu");
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final String menuLogo = Client.ClientName;
        DrawMenuLogo.drawString(5.0, menuLogo, (float)(this.width / 10 - this.fontRendererObj.getStringWidth(menuLogo) / 2), (float)(this.height / 25), Color.magenta.getRGB());
