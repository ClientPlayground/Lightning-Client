...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityPlayer> list = this.field_179434_b.worldObj.getEntitiesWithinAABB((Class<? extends EntityPlayer>)EntityPlayer.class, this.field_179434_b.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super EntityPlayer>)this.field_179435_c);
