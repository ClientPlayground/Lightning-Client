    ...
    private void loadVariants(final Collection<ModelResourceLocation> p_177591_1_) {
        for (final ModelResourceLocation modelresourcelocation : p_177591_1_) {
            try {
                ...
                ModelBakery.LOGGER.warn("Unable to load definition " + modelresourcelocation, (Throwable)exception);
            }
        }
    }
    ...
    private void loadModels() {
        ...
        while (!deque.isEmpty()) {
            ...
            try {
                ...
                ModelBakery.LOGGER.warn("In parent chain: " + ModelBakery.JOINER.join((Iterable)this.getParentPath(resourcelocation3)) + "; unable to load model: '" + resourcelocation3 + "'", (Throwable)exception);
            }
